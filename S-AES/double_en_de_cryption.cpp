...
double_en_de_cryption::double_en_de_cryption(QWidget *parent)
    : QWidget{parent}
{
    ...
    connect(encryptButton, &QPushButton::clicked, this, &double_en_de_cryption::double_encrypt);
    connect(decryptButton, &QPushButton::clicked, this, &double_en_de_cryption::double_decrypt);
}
